...
ifdef NRF5X_SDK_11 # SDK11 requires non-secure DFU that the adafruit tools support
	...
	@cp $(PROJ_NAME).app_hex $(PROJ_NAME)_app.hex
ifdef BOOTLOADER
	nrfutil pkg generate $(PROJ_NAME).zip --bootloader $(PROJ_NAME)_app.hex --bootloader-version 0xff --hw-version 52 --sd-req 0xA9 --debug-mode --key-file $(DFU_PRIVATE_KEY)
else
