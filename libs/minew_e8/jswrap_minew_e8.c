 ...
 *
 * Contains JavaScript interface for the Minew E8
 * ----------------------------------------------------------------------------
 */

/* DO_NOT_INCLUDE_IN_DOCS - this is a special token for common.py */

#include <jswrap_minew_e8.h>
...
/*JSON{
  "type" : "init",
  "generate" : "jswrap_minewe8_init"
}*/
void jswrap_minewe8_init() {
  // Force the Minew e8 js module to be loaded to 'Minew' global var
  jsvUnLock(jspEvaluate("global.Minew=require(\"e8\");",true));
}

/*JSON{
  "type" : "kill",
  "generate" : "jswrap_minewe8_kill"
}*/
void jswrap_minewe8_kill() {
